            ...
            <div class="cm-wrapper">
                <div class="copyright">
                    ...
                    */
                    ...
                    echo '<a href="' . esc_url( 'https://raratheme.com/wordpress-themes/influencer' ) .'" rel="author" target="_blank">' . esc_html__( ' Influencer', 'influencer' ) . '</a>' . esc_html__( ' by Rara Theme.', 'influencer' );
                ...
                <?php  
                echo '<div class="scroll-to-top"><span>' . esc_html__( 'Back to top','influencer' ) . '<img src="'. esc_url(get_template_directory_uri(). '/images/scroll-top-arrow.png' ) .'"></span></div>';
                ?>
            </div>
        </div>
    <?php }
